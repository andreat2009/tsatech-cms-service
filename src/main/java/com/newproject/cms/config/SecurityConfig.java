    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/cms/admin-audit", "/api/cms/admin-audit/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/cms/integrations", "/api/cms/integrations/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/cms/admin-audit", "/api/cms/admin-audit/**").hasRole("ADMIN")
